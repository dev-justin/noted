...
function Splash() {
  return (
    <div className="flex p-4 gap-4 min-h-screen">
      {/* Left Col */}
      <div className="border-2 border-bg-white p-8 rounded-lg items-center justify-center flex-col hidden md:flex relative">
        <div className="text-bg-white flex flex-col absolute top-4 left-1/2 -translate-x-1/2 gap-2">
          ...
          <button className="w-full py-2 text-xs rounded-lg font-bold text-bg-white border hover:bg-bg-white hover:text-bg-black transition duration-300 active:scale-95">
            Login
          </button>
        </div>
        ...
        <p className="text-bg-white/50 text-sm pt-4">
